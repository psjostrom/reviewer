---
name: frontload-integration
description: INTERNAL — invoked only by the /reviewer:review orchestrator. Do not invoke directly; invoke /reviewer:review instead. Reviews Frontload integration contracts and operational safety.
