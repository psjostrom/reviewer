---
description: INTERNAL — invoked only by the /review orchestrator. Do not invoke directly; invoke /review instead. Reviews Monkey C / Connect IQ crash and safety patterns.
mode: subagent
hidden: true
permission:
  read: allow
