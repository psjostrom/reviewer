---
description: INTERNAL — invoked only by the /parallel-review orchestrator. Do not invoke directly; invoke /review instead. Reviews error handling and loading/undefined state.
mode: subagent
hidden: true
permission:
  read: allow
