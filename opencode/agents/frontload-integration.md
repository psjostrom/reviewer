---
description: INTERNAL — invoked only by the /parallel-review orchestrator. Do not invoke directly; invoke /review instead. Reviews Frontload integration contracts and operational safety.
mode: subagent
hidden: true
permission:
  read: allow
